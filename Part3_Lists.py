...
#############################
#
#  start to draw parallels between arrays in another language and lists in Python. Lists in
...
# index, but you can also specify which index to pop off. see an example:
...
# Now we again use indexing to grab elements, but now there are two levels
