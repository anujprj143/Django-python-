...
# these are some examples of if, elif, and else statements:
...
# the user to write readable code, which is great for future we look back at
...
# Using For Loops for any sequence of elements. If we try to use a for loop with
...
# List Comprehension
# This technique allows us to quickly create lists with a single line of code.
# we can think of this as deconstructing a for loop with an append(). For Example:
