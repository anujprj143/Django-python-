...
# see how we can construct dictionaries to get a better understanding of how they work!
...
#Now calling items from the dictionary
my_dict['key3']
...
# affecting the values of a key as well. For instance:
my_dict['key1']

# Subtracting 123 from the value
...
# see how we can grab that value:

# calling again the keys
...
# We now have a good basic understanding how to construct dictionaries.
